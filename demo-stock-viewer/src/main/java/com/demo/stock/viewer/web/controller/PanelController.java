...
import com.demo.stock.viewer.web.entity.HttpResponse;
import com.demo.stock.viewer.web.entity.Stock;
import com.demo.stock.viewer.web.manager.LogManager;
...
public class PanelController {
    ...
    @ResponseBody
    public HttpResponse echoAdvisorWithHeader(@RequestParam(name = "time", defaultValue = "1", required = false) int time,
    ...
    public HttpResponse stress() {
        String result = stockService.pressProvider();
        LogManager.put(UUID.randomUUID().toString(), result);
        return new HttpResponse(result);
    }
