package com.ccb.cloud.nsf.demo.stock.provider.web.config;

import com.ccb.cloud.nsf.demo.stock.provider.web.client.AggregateClient;
import com.ccb.cloud.nsf.demo.stock.provider.web.client.mysql.MysqlClient;
import com.ccb.cloud.nsf.demo.stock.provider.web.client.mysql.StockJsonService;
...
import com.ccb.cloud.nsf.demo.stock.provider.web.client.MockClient;
import com.ccb.cloud.nsf.demo.stock.provider.web.client.NeteaseStockClient;
import com.ccb.cloud.nsf.demo.stock.provider.web.client.StockClient;
