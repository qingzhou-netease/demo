package com.ccb.cloud.nsf.demo.stock.provider.web.controller;

import com.ccb.cloud.nsf.demo.stock.provider.web.entity.Stock;
import com.ccb.cloud.nsf.demo.stock.provider.web.exception.ProviderException;
import com.ccb.cloud.nsf.demo.stock.provider.web.service.IProviderService;
...
public class StockController {
    ...
    public String echoWithHeader(HttpServletRequest request, @PathVariable(name = "key") String key, @PathVariable(name = "value") String value) {
        ...
        while (header.hasMoreElements()) {
            String heaerName = header.nextElement();
            log.append(heaerName).append(":").append(request.getHeader(heaerName)).append(System.lineSeparator());
        }
        log.append("]");
